...
PauseTimer proc     ;ustanovit zadershku
    push dx
    push ax
    push cx
    mov cx, 0     ;cx - starshee 4islo (t.e. cx*65535 + dx)
...
; set segment registers:
    ...
    mov al, ' '                                      
    mov ah, land_color
    ;v B8000h:[di] - posmeschaem ASCII-symbol
    ...
    sub cx, 2
    mov di, granica_len*23  ;23 stroka
    add di, 2 
    cld
    rep stosw
    
    mov bx, 1
left:          ;analogichno levuy stenku
    inc bx
    mov cx, bx 
    xor dx, dx
    left_pl:
